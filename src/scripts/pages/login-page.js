...
const LoginPage = {
      ...
      <article class="auth-article"> 
        <div class="auth-container">
          ...
          <form id="loginForm" name="loginForm" method="post">
            <input name="emailLogin" type="email" placeholder="Email Address...">
            <input name="passwordLogin" type="password" placeholder="Password...">
            <button type="submit">Login</button>
            <button id="googleLogin">
              <svg id="googleLogo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="30px" height="30px">
  ...
  async afterRender() {
    ...
    googleLoginButton.addEventListener('click', (event) => {
      ...
      Auth.googleSignIn(auth, provider);
    });

    loginForm.addEventListener('submit', (event) => {
      event.preventDefault();
      const email = document.forms.loginForm.emailLogin.value;
